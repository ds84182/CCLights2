...
public class GuiTablet extends GuiScreen {
	...
	public GuiTablet(NBTTagCompound n, World world)
	{
		...
		MonitorBase tile = (MonitorBase) Minecraft.getMinecraft().theWorld.getBlockTileEntity((Integer)TabMesg.getTabVar(trans, "x"),(Integer)TabMesg.getTabVar(trans, "y"),(Integer)TabMesg.getTabVar(trans, "z"));
		mon = tile.mon;
	}
	...
	{
		return x-((width/2)-mon.getWidth()/2);
	}
	
	public int applyYOffset(int y)
	{
		return y-((height/2)-mon.getHeight()/2);
	}
